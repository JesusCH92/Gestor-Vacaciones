 ...
 */
final class Version20200814164118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE calendar (id_calendar CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', id_company INT NOT NULL, init_date_day_off_request DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', end_date_day_off_request DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', no_working_days JSON NOT NULL, work_days JSON NOT NULL, working_year INT NOT NULL, UNIQUE INDEX UNIQ_6EA9A146E5F8C1CD (working_year), INDEX IDX_6EA9A1469122A03F (id_company), PRIMARY KEY(id_calendar)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
