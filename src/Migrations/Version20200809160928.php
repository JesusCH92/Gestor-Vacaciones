 ...
 */
final class Version20200809160928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE remaining_day_off_summary_by_user (id_remaining_day_off_summary_by_user INT AUTO_INCREMENT NOT NULL, id_user CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', id_calendar INT NOT NULL, type_day_off VARCHAR(30) NOT NULL, count_type_day_off_remaining INT NOT NULL, init_date_day_off_request DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', end_date_day_off_request DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_CCF515776B3CA4B (id_user), INDEX IDX_CCF515773E724DD3 (id_calendar), PRIMARY KEY(id_remaining_day_off_summary_by_user)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE remaining_day_off_summary_by_user ADD CONSTRAINT FK_CCF515776B3CA4B FOREIGN KEY (id_user) REFERENCES user (id_user)');
        $this->addSql('ALTER TABLE remaining_day_off_summary_by_user ADD CONSTRAINT FK_CCF515773E724DD3 FOREIGN KEY (id_calendar) REFERENCES calendar (id_calendar)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE remaining_day_off_summary_by_user DROP FOREIGN KEY FK_CCF515776B3CA4B');
        ...
        $this->addSql('ALTER TABLE remaining_day_off_summary_by_user DROP FOREIGN KEY FK_CCF515773E724DD3');
        $this->addSql('ALTER TABLE feastday DROP FOREIGN KEY FK_294E94BE3E724DD3');
        $this->addSql('DROP TABLE user');
        $this->addSql('DROP TABLE type_day_off');
        $this->addSql('DROP TABLE remaining_day_off_summary_by_user');
