 ...
 */
final class Version20200810002638 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE calendar (id_calendar INT AUTO_INCREMENT NOT NULL, id_company INT NOT NULL, init_date_day_off_request DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', end_date_day_off_request DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', work_days JSON NOT NULL, no_working_days JSON NOT NULL, working_year INT NOT NULL, UNIQUE INDEX UNIQ_6EA9A1469122A03F (id_company), PRIMARY KEY(id_calendar)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE day_off_form (code_day_off_form VARCHAR(36) NOT NULL, id_user CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', id_calendar INT NOT NULL, type_day_off VARCHAR(30) NOT NULL, observation VARCHAR(255) DEFAULT NULL, created_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', id_supervisor VARCHAR(36) DEFAULT NULL, status_day_off_form VARCHAR(15) NOT NULL, count_day_off_request INT NOT NULL, INDEX IDX_90E3A5D36B3CA4B (id_user), INDEX IDX_90E3A5D33E724DD3 (id_calendar), PRIMARY KEY(code_day_off_form)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
