...
class DayOffFormRequest
{
     ...
     */
    public function __construct($codeDayOffForm, $dayOffSelected)
    {
    ...
    public function getDayOffSelected(): ?DateTimeInterface
    {
        return $this->dayOffSelected;
    }

    public function setDayOffSelected(DateTimeInterface $dayOffSelected): self
    {
        $this->dayOffSelected = $dayOffSelected;
    ...
    public function getCodeDayOffForm()
    {
